        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="tile-stats">
                    ...
                    <h3 class="title-statistical">Bill processed</h3>
                </div>
                </div>
            </div>
            </div>
                      ...
                      <tbody>
                        <?php foreach($data["ordernew"] as $key=>$value){ ?>
                          <tr>
                            ...
                            <?php if($value["status"] == "Wait processing"){ ?>
                            ...
                            <a style="height: 35px;" class="btn btn-primary" href="<?=base?>admin/orderdetails&id_order=<?=$value['id']?>&id_user=<?=$value['user_id']?>">Details</a>
                            </td>
                          </tr>
                        <?php }?>
                      </tbody>
