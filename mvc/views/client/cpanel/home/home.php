					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-6">
									<img style="min-height: 400px; object-fit: cover;max-height: 400px;min-width: 390px;" src="public/images/img_banner/banner02.jpg" class="girl img-responsive" alt="" />
								</div>
							</div>
        ...
        <div class="row">
            <div class="col-sm-3" id="mobi">
					<div class="left-sidebar">
						<h2 style="padding-top: 3px ;">Shop By Category</h2>
						<div class="panel-group category-products" id="accordian">
							<div class="panel panel-default">
								<div class="panel-heading">
									<h4 class="panel-title"><a class="allproduct" href="javascript:void(0)">All Product</a></h4>
								</div>
							</div>
            ...
            <div class="col-sm-9 padding-right">
                    ...
                    <div class="">
                        <h2 class="title text-center" style="padding-top: 3px;">List of products</h2>
                    </div>
                  
                    <div  class="features_items" id="listproduct">
                    </div>
                ...
                <div class="category-tab"><!--category-tab-->
                    <h2 class="title text-center" style="padding-top: 3px;">New Product</h2>
                ...
                <div class="recommended_items">
                    <h2 class="title text-center">Selling products</h2>
